...
async function run() {
    ...
    const sunmoonBuilder: SunMoonBuilder = new SunMoonBuilder(logger, cache, simpleImageWriter);
    ...
    let success = true;
    success = success && await sunmoonBuilder.CreateImages("Onset, MA", "OnsetSunMoon.jpg", "42.4", "-71.6", IPGEOLOACATION_API_KEY, timeZone, "");
